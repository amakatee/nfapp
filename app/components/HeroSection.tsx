  ...
  return (
    <div className="min-h-screen bg-white ">
      ...
      <div className="flex flex-col min-h-screen space-y-8">
        ...
        <div 
          ref={image1Ref}
          className="flex-1 min-h-[35vh] relative overflow-hidden bg-gradient-to-r from-gray-50 to-white"
        >
      ...
      >
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white p-8">
            <div className="text-3xl md:text-4xl font-bold mb-4">Video ? ili photo</div>
            <div className="text-white/80 text-lg mb-8">kakoi to text</div>
            
           
            
            <p className="mt-6 text-white/70">mb esche text</p>
          </div>
        </div>
      </div>
    ...
    Бизнес-логистика премиум-класса из Китая
  </h2>
  
  {/* Description with clean minimal spacing */}
  <div className="space-y-6">
    <p className="text-gray-700 text-lg md:text-xl leading-relaxed font-light tracking-normal">
